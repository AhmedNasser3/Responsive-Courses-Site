			  ...
			  <div class="table-responsive">
               <table class="table">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td>{{$key+1}}</td>
                      <td>{{$subcategory['category']['category_title']}}</td>
                      <td>{{$subcategory->subcategory_title}}</td>
                      <td>{{$subcategory->subcategory_description}}</td>
                      <td><img style="width: 100px" src="{{ $subcategory->subcategory_img }}"  class="course_image"></td>
                      ...
                      <td><a href="{{route('subcategory.edit', ['subcategory' => $subcategory])}}"><i class="fa-solid fa-pen-to-square"></i></a></td>
					</tr>
					@endforeach
                  </tbody>
                </table>
